...
----
{
    "id" : "24e124128c067999" ,
    "model" : "AM107",
    "location" : "nhnacademy/gyeongnam/class_a",
    "sensor_type" : ["temperature","humidity","CO2","TVOC","Light","Barometric Pressure"]
}
----
...
----
{
    "sensor": [ "temperature", "humidity", "CO2", "TVOC", "Light", "Barometric Pressure" ]
}
----
...
/ep/temperature?count=10&st=1696772438&et=1696772438
...
{
    "type" : "temperature",
    "start_time" : 1696772438,
    "end_time" : 1696772498,
    "device" : [
        {
            "id" : "1696772438",
            "value" : [ 22.4, 22.4, 22.5, 22.4,...  ]
        },
        {
            ...
        }
